...
<h3>Name:  HITHESH RAJ R K         </h3>
<h3>Register Number/Staff Id:  212225040129       </h3>
<H3>Aim:</H3>
<p>
        ...
        while True:
            ...
            if self.player_turn == 'X':
                while True:
                    ...
                    # Start of modified code block for input handling
                    while True:
                        try:
                            px_str = input('Insert the X coordinate (e.g., 0, 1, or 2): ')
                            px = int(px_str)
                            py_str = input('Insert the Y coordinate (e.g., 0, 1, or 2): ')
                            py = int(py_str)
                            break # Exit try-except loop if conversion is successful
                        except ValueError:
                            print('Invalid input. Please enter a single integer for the coordinate (e.g., 0, 1, or 2).')
...
### Output:
<img width="406" height="903" alt="Screenshot 2026-08-19 154246" src="https://github.com/user-attachments/assets/470b6443-048c-4df8-9896-e93dc9fc7eab" />
